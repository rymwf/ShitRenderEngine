...
static void ImGui_ImplShitRenderer_SetupRenderState(uint32_t imageIndex, ImDrawData *draw_data, Shit::Pipeline *pipeline, Shit::CommandBuffer *command_buffer, ImGui_ImplShitRendererH_FrameRenderBuffers *rb, int fb_width, int fb_height)
{
...
void ImGui_ImplShitRenderer_RenderDrawData(uint32_t imageIndex, ImDrawData *draw_data, Shit::CommandBuffer *command_buffer, Shit::Pipeline *pipeline)
{
...
static std::vector<Shit::ImageView *> swapchainImageViews;
	...
	std::vector<Shit::Framebuffer *> &framebuffers)
{
	...
	{
		swapchainImageViews[i] = device->Create(Shit::ImageViewCreateInfo{
			images[i],
			Shit::ImageViewType::TYPE_2D,
...
bool ImGui_ImplShitRenderer_Init(ImGui_ImplShitRenderer_InitInfo *info)
{
	...
	io.KeyMap[ImGuiKey_Tab] = Shit::KeyCode::KEY_TAB;
	io.KeyMap[ImGuiKey_LeftArrow] = Shit::KeyCode::KEY_LEFT;
	io.KeyMap[ImGuiKey_RightArrow] = Shit::KeyCode::KEY_RIGHT;
	io.KeyMap[ImGuiKey_UpArrow] = Shit::KeyCode::KEY_UP;
	io.KeyMap[ImGuiKey_DownArrow] = Shit::KeyCode::KEY_DOWN;
	io.KeyMap[ImGuiKey_PageUp] = Shit::KeyCode::KEY_PRIOR;
	io.KeyMap[ImGuiKey_PageDown] = Shit::KeyCode::KEY_NEXT;
	io.KeyMap[ImGuiKey_Home] = Shit::KeyCode::KEY_HOME;
	io.KeyMap[ImGuiKey_End] = Shit::KeyCode::KEY_END;
	io.KeyMap[ImGuiKey_Insert] = Shit::KeyCode::KEY_INSERT;
	io.KeyMap[ImGuiKey_Delete] = Shit::KeyCode::KEY_DELETE;
	io.KeyMap[ImGuiKey_Backspace] = Shit::KeyCode::KEY_BACK;
	io.KeyMap[ImGuiKey_Space] = Shit::KeyCode::KEY_SPACE;
	io.KeyMap[ImGuiKey_Enter] = Shit::KeyCode::KEY_RETURN;
	io.KeyMap[ImGuiKey_Escape] = Shit::KeyCode::KEY_ESCAPE;
	io.KeyMap[ImGuiKey_A] = Shit::KeyCode::KEY_A;
	io.KeyMap[ImGuiKey_C] = Shit::KeyCode::KEY_C;
	io.KeyMap[ImGuiKey_V] = Shit::KeyCode::KEY_V;
	io.KeyMap[ImGuiKey_X] = Shit::KeyCode::KEY_X;
	io.KeyMap[ImGuiKey_Y] = Shit::KeyCode::KEY_Y;
	io.KeyMap[ImGuiKey_Z] = Shit::KeyCode::KEY_Z;
	// io.KeyMap[ImGuiKey_KeyPadEnter] =Shit::KeyCode)::;
...
// }
void ImGui_ImplShitRenderer_RecordCommandBuffer(uint32_t imageIndex)
{
	auto cmdBuffer = g_ShitRendererInitInfo.commandBuffers[imageIndex];
